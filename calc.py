...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QHBoxLayout,\
    QComboBox, QDialog, QVBoxLayout, QGroupBox, QGridLayout, QTextEdit,\
    QLabel, QRadioButton, QSpinBox, QListWidget, QTabWidget, QSizePolicy,\
    QListWidgetItem
...
class WidgetGallery(QDialog):
    ...
    def createGuardiansStrengthWidget(self):
        ...
        self.globalGuardiansStrength.currentTextChanged.connect(
            self.calculateValue)
        self.zoneGuardianStrength.currentTextChanged.connect(
            self.calculateValue)
    ...
    def createPandoraWidget(self):
        ...
        self.quantities.addItems(['Few 1-5',
                                  'Several 5-9',
                                  'Pack 10-19',
                                  'Lots 20-49',
                                  'Horde 50-99',
        ...
        self.object_list.itemDoubleClicked.connect(
            lambda: self.object_list.takeItem(
                self.object_list.currentRow()))
    ...
    def calculateGuard(self):
        ...
        total_AI_Value = part_1 * coefficient_1[protection_index] + \
            part_2 * coefficient_2[protection_index]
